...
export function serializeGameCard(game: any, ctx: SerializeCtx) {
  ...
  return {
    ...
    pro_home_color: linkedEvent?.proHomeTeam?.primary_color ?? game.homeTeam?.primary_color ?? null,
    pro_away_color: linkedEvent?.proAwayTeam?.primary_color ?? game.awayTeam?.primary_color ?? null,
...
export function serializeEventCard(event: any, ctx: SerializeCtx) {
  ...
  return {
    ...
    pro_home_color: event.proHomeTeam?.primary_color ?? event.team?.primary_color ?? null,
